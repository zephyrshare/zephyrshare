...
const VerificationLinkEmail = ({ url = 'https://zephyrshare.com' }: { url: string }) => {
  return (
    <Html>
      <Head />
      <Preview>Your ZephyrShare Login Link</Preview>
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
            <Heading className="text-2xl font-normal text-center p-0 mt-4 mb-8 mx-0">
              <span className="font-bold tracking-tighter">ZephyrShare</span>
            </Heading>
            <Heading className="mx-0 my-7 p-0 text-center text-xl font-semibold text-black">
              Your ZephyrShare Login Link
            </Heading>

            <Text className="text-sm leading-6 text-black">Welcome to ZephyrShare!</Text>
